...
<head>
  ...
  <title>Jesus Movement | Contact Us</title>
      <!-- *Bootstrap -->
            ...
            <div class="container-fluid">
              ...
              <h3 class="bold">Contact Us</h3>
               <form action="https://formspree.io/f/moqynolq" method="POST" >
                ...
                <div class="form-group row">
                  <label for="message" class='input-label col-sm-4 col-form-label text-left font-weight-bold'>Message</label>
                  <div class="col-sm-8">
                    <textarea name="message" class="form-control form-control-lg" id="message" cols="" rows="6" required="required"></textarea>
                  </div>
                </div>
